...
//
//                        for(int y = row.getFirstCellNum(); y< columnNum; y++) {
//                            cell = row.getCell(y);
//                            if(null == cell){
//                                li.add("");
//                                continue;
...
//        }
//    }
//    public BigDecimal getFormats(BigDecimal str) {
//        if(str==null) {
//            str=new BigDecimal(0);
//            return str;
//        }else{
//            return str;
//        }
//    }
//    public Integer getFormatInt(Integer str) {
//        if(str==null) {
//            str=0;
//            return str;
//        }else{
...
//        }
//    }
//    public Date getFormatDate(Date str) {
//        if(str==null) {
//            str=null;
//            return str;
//        }else{
